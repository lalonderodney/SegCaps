...
from networks.custom_layers.capsule_layers import ConvCapsuleLayer, DeconvCapsuleLayer, Mask, Length, ExpandDim, RemoveDim

def SegCaps(input_shape, r1=3, r2=3, n_class=2):
    ...
    deconv_cap_1_1 = DeconvCapsuleLayer(kernel_size=4, num_capsule=8, num_atoms=32, upsamp_type='deconv',
                                        scaling=2, padding='same', routings=r2,
    ...
    deconv_cap_1_2 = ConvCapsuleLayer(kernel_size=5, num_capsule=4, num_atoms=32, strides=1,
                                      padding='same', routings=r1, name='deconv_cap_1_2')(up_1)
    ...
    deconv_cap_2_2 = ConvCapsuleLayer(kernel_size=5, num_capsule=4, num_atoms=16, strides=1,
                                      padding='same', routings=r1, name='deconv_cap_2_2')(up_2)
    ...
    seg_caps = ConvCapsuleLayer(kernel_size=1, num_capsule=1, num_atoms=16, strides=1, padding='same',
                                routings=r1, name='seg_caps')(up_3)
    ...
    def shared_decoder(mask_layer):
        ...
        recon_remove_dim = RemoveDim(name='recon_remove_dim', input_shape=(H, W, C, A))(mask_layer)
